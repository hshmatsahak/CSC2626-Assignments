...
class DiscreteDrivingPolicy(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3, 24, kernel_size=4, stride=2, padding=1),  # Assuming input channels = 3 (RGB)
            nn.ReLU(),
        ...
        self.classifier = nn.Sequential(
            nn.Linear(4096, 64),  # Adjust the size here based on your final feature map dimensions
            nn.ReLU(),
